...
class m3_kp_api():
	################################ Join/Leave OPs  ###########################
	def __init__(self, PrintDebug = False, IP="localhost", port = 10010, SS_name = "X", KP_name = None):
	...
	def load_rdf_update (self, triples_insert_in , triples_remove_in):
		...
		self.test_rdf_update.update(triples_insert_in, "rdf-m3", triples_remove_in, "rdf-m3", confirm = True)
